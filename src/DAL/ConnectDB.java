...
public class ConnectDB {
    ...
    public static Connection getConnection() {
        try {
            ...
            + "databaseName=THITRACNGHIEM1;user=Nguyen;password=123456789;";
    ...
    public static int CheckLogIn(String Users, String MatKhau) throws SQLException {
        Connection conn = getConnection();
        String cauTruyVanSQL = "exec UserLogin '"+ Users +"' , '"+ MatKhau +"'";  // Tên của Stored Procedure và số lượng tham số
        Statement stmt = conn.createStatement();;           
